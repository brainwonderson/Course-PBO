    ...
    public static void main ( String[] _args )
    {
        ...
        while ( true )
        {
            ...
            switch ( order )
            {
                ...
                case "enrollment-add":
                    ...
                    boolean found = false;
                    for (Enrollment enr : enrolz) {
                        if (enr.getCode().equals(buf[0]) &&
                            enr.getId().equals(buf[1]) &&
                            enr.getYear().equals(buf[2]) &&
                            enr.getSemester().equals(buf[3])) {
                            enr.setGrade(buf[4]);
                            found = true;
                            break;
                        }
        ...
        for (Enrollment x : enrolz) {
            if (x.getId().equals(buf[0])) {
                ...
                if (tempCou != null) {
                    total_credit += tempCou.getCredit();
                    if (x.getGrade() != null && !x.getGrade().equals("None")) {
                        switch (x.getGrade()) {
        ...
        temp_gpa = (total_credit == 0) ? 0.00f : num / total_credit;
        tempStu = isDuplicateStu(buf[0]);
        System.out.printf("%s|%s|%s|%s|%.2f|%d\n", buf[0],
                                                    tempStu != null ? tempStu.getStuName() : "None",
                                                    tempStu != null ? tempStu.getEduYear() : "None",
                                                    tempStu != null ? tempStu.getStuProg() : "None",
                                                    temp_gpa,
                                                    total_credit);
        break;
